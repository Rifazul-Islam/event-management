...
<div className="card card-compact  bg-base-100 shadow-2xl">
  ...
  <div className="card-body">
    ...
    <div>
     ...
     <Link to={`/service/${id}`} >  <button className="btn  w-full hover:bg-slate-400 text-xl bg-slate-300 text-orange-600 font-bold border-none my-6 capitalize">  Details Service  </button> </Link>
